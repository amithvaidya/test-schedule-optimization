...
clear all;
close all;
data=[0 0 0 1 1 0 1 1]; % information
...
data_NZR=2*data-1; % Data Represented at NZR form for QPSK modulation (Non Return to zero form)
...
for(i=1:1:length(data)/2)
    ...
    %above line indicates multiplication of received & Quadrature phase carred signal
